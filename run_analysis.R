...
#
#  2 creates an "human-readable" text file from the merged UCI HAR Dataset 
#    containing the mean or std-related variables for each record in the "X" 
#    file with subject number and activity name
#
#  3 averages each 561 features grouped by subject and activity contained in 
#    the "X" file and wites the resulting table on the disk
#
#  it requires to work:
